...
2. Воно сприяє композиції над успадкуванням. [composition](#перевага-композиції-над-успадкуванням).
3. Воно підтримує принцип єдиного обов'язку (SRP) [Single Responsibility Pattern](#принцип-єдиного-обовязку-srp).
